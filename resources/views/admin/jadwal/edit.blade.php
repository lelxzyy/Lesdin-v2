...
<div class="max-w-3xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-800">Edit Jadwal Pendaftaran</h1>
            <p class="text-sm text-gray-500 mt-1">{{ $jadwal->nama_periode }}</p>
        </div>
        ...
        <form method="POST" action="{{ route('admin.jadwal.update', $jadwal) }}" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" 
                       name="nama_periode" 
                       id="nama_periode"
                       value="{{ old('nama_periode', $jadwal->nama_periode) }}"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="date" 
                           ...
                           value="{{ old('mulai_pendaftaran', $jadwal->mulai_pendaftaran->format('Y-m-d')) }}"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                           required>
                ...
                <div>
                    ...
                    <input type="date" 
                           ...
                           value="{{ old('akhir_pendaftaran', $jadwal->akhir_pendaftaran->format('Y-m-d')) }}"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                           required>
            ...
            <div>
                ...
                <input type="date" 
                       ...
                       value="{{ old('tanggal_pengumuman', $jadwal->tanggal_pengumuman?->format('Y-m-d')) }}"
                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
            ...
            <div class="flex gap-3 pt-4">
                <button type="submit" 
                        class="flex-1 px-6 py-3 bg-amber-600 text-white font-semibold rounded-lg hover:bg-amber-700 transition">
                    Update Jadwal
                </button>
                <a href="{{ route('admin.jadwal.index') }}"
